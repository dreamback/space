        ...
        <template v-else>
            <template v-if="type == 'password'">
                <input ref="input" v-if="!showPwd" type="password"
                       v-model.trim="currentValue" :name="name" @focus="focusHandler" @blur="blurHandler" :maxlength="max" :placeholder="placeholder" :autocomplete="autocomplete" :readonly="readonly" :disabled="disabled"
                >
